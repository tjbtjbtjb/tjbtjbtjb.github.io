    ...
    function processData(data) {
        ...
        var values = lines[j].split(','); // Split up the comma seperated values
        	...
        	if(values[0]=='United Kingdom' && values[1]=='United Kingdom') {
        		...
        		for(t=24;t<values.length;t++) {
        			//time.push(headings[t]);
        			data2.push((values[t]-values[t-1]));
        		}
        	}
        	...
        	if(values[1]=='Italy') {
        		...
        		for(t=24;t<values.length;t++) {
        			//time.push(headings[t]);
        			data3.push((values[t]-values[t-1]));
        		}
        	}
        	if(values[1]=='Spain') {
        		...
        		for(t=24;t<values.length;t++) {
        			//time.push(headings[t]);
        			data4.push((values[t]-values[t-1]));
        		}
        	}
        	...
        	if(values[1]=='Germany') {
        		...
        		for(t=24;t<values.length;t++) {
        			//time.push(headings[t]);
        			data5.push((values[t]-values[t-1]));
        		}
        	}
        }
...
var layout = {
  ...
  yaxis: {
	...
	title:'Confirmed daily absolute increase'
};
